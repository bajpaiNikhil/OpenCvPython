...
img=cv2.imread("resources/bag.png")
...
imgstack=stackImages(0.6,([imgResize,imgGrey]))


#cv2.imshow("horO/P",hor)
cv2.imshow("stackImg",imgstack)

cv2.putText(ver,"IamStupid",(400,300),cv2.FONT_ITALIC,1,(0,0,255),5)
cv2.imshow("verO/P",ver)
cv2.waitKey(0)